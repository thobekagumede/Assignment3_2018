...
public class ParallelProgram
{	
	public static String inputFileName = "sample_input_5000.txt";
	public static String outputFileName = "sample_output_5000.txt";
	...
	private static void computeParallel(int numOfTrees, Tree[] treeArray, int rowSize, double[] sunlightMatrix) {
		// Start parallel
		StringBuffer treeSumString = new StringBuffer();
		...
		String output = average + System.lineSeparator() + numOfTrees + System.lineSeparator() + treeSumString.toString().trim();
